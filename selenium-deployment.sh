...
docker image tag selenium/standalone-chrome gcr.io/tmbmonitoring/selenium_image
#docker push us.gcr.io/<PROJECT_NAME>/<SELENIUM_IMAGE_NAME>
docker push gcr.io/tmbmonitoring/selenium_image
...
#    --memory 2G
#    --region us-west1
gcloud run deploy selenium-service-webscraper --region us-west1 --image gcr.io/tmbmonitoring/selenium_image --port 4444 --memory 2G
...
#    --member serviceAccount:<INVOKING_SERVICE_ACCOUNT>@tmbmonitoring.iam.gserviceaccount.com \
#    --role roles/run.invoker
#    --region us-west1

gcloud run services add-iam-policy-binding selenium-service-webscraper --member serviceAccount:selenium-service-account@tmbmonitoring.iam.gserviceaccount.com --role roles/run.invoker --region us-west1
