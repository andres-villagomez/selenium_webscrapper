...
if os.environ.get('https://selenium-service-webscraper-3bdzsiprsa-uw.a.run.app/ui') is not None:
    selenium_url = os.environ.get('https://selenium-service-webscraper-3bdzsiprsa-uw.a.run.app/ui')
else:
